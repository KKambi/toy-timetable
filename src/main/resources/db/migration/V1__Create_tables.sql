create table course (id bigint NOT NULL AUTO_INCREMENT, code varchar(50), title varchar(50), professor varchar(50), building varchar(10), room varchar(10), start_time integer not null, end_time integer not null, day_of_week varchar(10), primary key (id));
